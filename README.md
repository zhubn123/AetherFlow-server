...
- `com.berlin.aetherflow.system`: system-level modules such as auth, user, and monitor
- `com.berlin.aetherflow.wms`: WMS business modules such as warehouse, location, material, inbound, outbound, inventory, and inventory
