...
) engine = InnoDB comment '仓库表' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '库位表' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '物料表' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '入库单' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '入库单明细' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '出库单' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '出库单明细' collate = utf8mb4_unicode_ci;
...
) engine = InnoDB comment '库存表' collate = utf8mb4_unicode_ci;
