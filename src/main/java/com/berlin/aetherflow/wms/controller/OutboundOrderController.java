...
public class OutboundOrderController {
    ...
    @PostMapping
    public Result<?> createDraft(@RequestBody OutboundOrderBo bo) {
        bo.setId(null);
    ...
    @PutMapping("/{id}")
    public Result<?> update(@PathVariable Long id, @RequestBody OutboundOrderBo bo) {
        bo.setId(id);
    ...
    public Result<?> applyAction(@PathVariable Long id, @RequestBody OutboundOrderActionBo bo) {
    ...
    public Result<?> removeBatch(@RequestParam List<Long> ids) {
        return Result.success(outboundOrderService.removeByIds(ids));
    }
}
